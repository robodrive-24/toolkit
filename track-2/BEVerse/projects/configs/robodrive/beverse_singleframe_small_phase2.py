    ...
    dict(
        ...
        transforms=[
            ...
            dict(
                ...
                meta_keys=('filename', 'sample_idx', 'ori_shape', 'img_shape', 'lidar2img', 'depth2img', 'cam2img', 'pad_shape', 'scale_factor', 'flip',
...
data = dict(
    ...
    test=dict(
        ...
        grid_conf=grid_conf,
        map_grid_conf=map_grid_conf,
        ann_file=data_info_path + 'robodrive_infos_temporal_test.pkl',
        modality=input_modality),
)
