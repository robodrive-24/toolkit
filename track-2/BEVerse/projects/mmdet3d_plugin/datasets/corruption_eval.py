...
def load_gt(nusc: NuScenes, eval_scenes: list, box_cls, verbose: bool = False):
    """
    ...
    if verbose:
        print('Loading annotations for split contains {} scenes from nuScenes version: {}'.format(len(eval_scenes), nusc.version))
    ...
    for sample_token in sample_tokens_all:
        ...
        if scene_record['token'] in eval_scenes:
