...
class NuScenesCorruptionDataset(Custom3DDataset):
    r"""NuScenes Dataset.
        ...
        if self.modality['use_camera']:
            ...
            for cam_type, cam_info in info['cams'].items():
                ...
                if self.corruption != 'clean':
                    data_path = osp.join(self.corruption_root, self.corruption, data_path)
            ...
            for i, box in enumerate(boxes):
                ...
                if np.sqrt(box.velocity[0]**2 + box.velocity[1]**2) > 0.2:
                    if name in [
                        ...
                        attr = NuScenesCorruptionDataset.DefaultAttribute[name]
                else:
    ...
    def _evaluate_single(self,
        ...
        from .corruption_eval import NuScenesEval_custom
        ...
        nusc_eval = NuScenesEval_custom(
            ...
            eval_set=self.sample_scenes_dict[self.corruption],
    ...
    def evaluate(self,
        ...
        print('Don\'t support evaluate locally, please submit the result folder to server.')
