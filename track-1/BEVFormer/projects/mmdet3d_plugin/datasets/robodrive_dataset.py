...
class RobodriveDataset(NuScenesCorruptionDataset):
    r"""NuScenes Dataset.
        ...
        if self.modality['use_camera']:
            ...
            for cam_type, cam_info in info['cams'].items():
                ...
                if self.corruption != 'clean':
                    data_path = data_path.replace('./data/nuscenes', osp.join(self.corruption_root, self.corruption))
    ...
    def _evaluate_single(self,
        ...
        print('Don\'t support evaluation locally, please upload to the server!')
