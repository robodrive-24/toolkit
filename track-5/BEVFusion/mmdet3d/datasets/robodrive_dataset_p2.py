...
class RoboDriveDatasetP2(Custom3DDataset):
    r"""NuScenes Dataset.
    ...
    def get_data_info(self, index: int) -> Dict[str, Any]:
        ...
        lidar_path = info["lidar_path"].replace('./data/nuscenes', './data/robodrive-sensor-p2')
        sweeps = info["sweeps"]
        for idx, sweep in enumerate(sweeps):
            data_path = sweep["data_path"]
            data_path = data_path.replace('./data/nuscenes', './data/robodrive-sensor-p2')
        ...
        if self.modality["use_camera"]:
            ...
            for _, camera_info in info["cams"].items():
                ...
                data_path = data_path.replace('./data/nuscenes', '/home/shaoyux/data/robodrive-sensor-p2')
            ...
            for i, box in enumerate(boxes):
                ...
                if np.sqrt(box.velocity[0] ** 2 + box.velocity[1] ** 2) > 0.2:
                    if name in [
                        ...
                        attr = RoboDriveDatasetP2.DefaultAttribute[name]
                else:
